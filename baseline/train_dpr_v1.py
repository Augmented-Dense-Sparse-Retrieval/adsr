...
from utils import get_dense_args, timer, reconstruct_embedding, split_batch


class DenseTrainV1(Dense):
    """DPR Custom Trainer 및 Dataloader"""
    def __init__(self, **kwargs):
        super(DenseTrainV1, self).__init__(**kwargs)
    ...
    def prepare_dataloaders(self,dataset = None,tokenizer = None):
        ...
        p_seqs_t = tokenizer(train_data['context'],padding = "max_length", truncation = True,
                            return_tensors = 'pt', max_length = 512*3, return_overflowing_tokens = True )
        ...
        p_seqs_v = tokenizer(valid_data['context'],padding = "max_length",truncation = True,
                            return_tensors = 'pt',max_length = 512*3, return_overflowing_tokens = True )
    ...
    def train(self, args = None):
        ...
        for _ in train_iterator:
            ...
            for step, batch in enumerate(epoch_iterator):
                    ...
                    batch_new, split_info = split_batch(batch, batch_size, max_len = 512)
                    p_inputs = {
